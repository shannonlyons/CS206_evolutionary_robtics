...
class SOLUTION:
    ...
    def Create_Body(self):
        ...
        pyrosim.Send_Joint(name="Torso_LeftLegFirst", parent="Torso", child="LeftLegFirst", type="revolute",
                           position=[-0.5, -0.1, 1], jointAxis="0 1 0")
        ...
        pyrosim.Send_Joint(name="Torso_RightLegFirst", parent="Torso", child="RightLegFirst", type="revolute",
                           position=[0.5, -0.1, 1], jointAxis="0 1 0")
        ...
        pyrosim.Send_Joint(name="LeftLegFirst_LeftLowerLegFirst", parent="LeftLegFirst", child="LeftLowerLegFirst",
        ...
        pyrosim.Send_Joint(name="RightLegFirst_RightLowerLegFirst", parent="RightLegFirst", child="RightLowerLegFirst",
                           type="revolute", position=[1, 0, 0], jointAxis="0 1 0")
